...
4. If you want to provide interference, do variable manipulation by changing the variables as follows:
   ...
   Notes: a. A value of 1 or -3.12 is the value for enabling interference.
          b. A value of 0 or -1.56 is the value for stopping interruptions.
5. If you want to finish the program, type the STOP topic in the MQTT Explorer Application to stop the detection 
   program simulation from TEP-mod-plant-mqtt.py.
